...
// ANSWER: No because we would need ot search through the array to find the fourth element.
...
// ANSWER: They essentially do the same things but one loops through the string and the other counts the string by letters.
